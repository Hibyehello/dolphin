...
void GeneralWidget::CreateWidgets()
{
  ...
  m_lock_window_to_right = new ConfigBool(tr("Lock Window to Right"),
                                          Config::MAIN_RENDER_WINDOW_LOCK_RIGHT, m_game_layer);
  ...
  m_options_layout->addWidget(m_lock_window_to_right, 1, 0);
  m_options_layout->addWidget(m_no_ui_delay, 1, 1);
